...
if( !function_exists('wk_pdf_cli_build') )
{
...
if( !function_exists('wk_img_cli_build') )
{
...
if( !function_exists('wk_opts_build') )
{
...
if( !function_exists('wk_conv_file_to_pdf_file') )
{
	/**
...
if( !function_exists('wk_conv_file_to_img_file') )
{
	/**
...
if( !function_exists('wk_conv_file_to_pdf_str') )
{
	/**
...
if( !function_exists('wk_conv_file_to_img_str') )
{
	/**
...
if( !function_exists('wk_conv_str_to_pdf_str') )
{
	/**
...
if( !function_exists('wk_conv_str_to_img_str') )
{
	/**
...
if( !function_exists('wk_conv_str_to_pdf_file') )
{
	/**
...
if( !function_exists('wk_conv_str_to_img_file') )
{
	/**
